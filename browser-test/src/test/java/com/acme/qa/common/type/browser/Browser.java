...
public class Browser {
    ...
    // setting with the correct CapabilityType.BROWSER_NAME seems sufficient; if this is true we may want to
    ...
    public static void main(String [] args) {
        ...
        caps = Browser.getDesiredCapabilities( BrowserOS.WINDOWS_7, BrowserVersion.CHROME_35 );
        System.out.println( "==========================================================" );
        System.out.println( String.format("[expected]\n%s\n%s", BrowserOS.WINDOWS_7.toString(), BrowserVersion.CHROME_35.toString()) );
        System.out.println( "==========================================================" );
        ...
        System.out.println("opera=" + DesiredCapabilities.opera().getBrowserName());
